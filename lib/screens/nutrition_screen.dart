...
const List<_HealthyFoodRef> _healthyFoodRefs = [
  // 🍓 Fruits — generally lower calorie
  ...
  _HealthyFoodRef('pedaço de melancia (≈300 g)',
      'pedaços de melancia (≈300 g)', 90),
  _HealthyFoodRef('pedaço de melão (≈200 g)',
      'pedaços de melão (≈200 g)', 60),
  ...
  _HealthyFoodRef('mamão (1 fatia média)', 'fatias médias de mamão', 40),
  _HealthyFoodRef('maracujá', 'maracujás', 50),
  _HealthyFoodRef('pitaya', 'pitayas', 60),
  _HealthyFoodRef('coco fresco (pequena porção)',
      'porções pequenas de coco fresco', 70),

  // 🥦 Vegetables — especially low calorie
  ...
  _HealthyFoodRef('porção de alface (100 g)',
      'porções de alface (100 g)', 15),
  _HealthyFoodRef('porção de rúcula (100 g)',
      'porções de rúcula (100 g)', 25),
  _HealthyFoodRef('porção de couve (100 g)',
      'porções de couve (100 g)', 35),
  _HealthyFoodRef('porção de espinafre (100 g)',
      'porções de espinafre (100 g)', 23),
  _HealthyFoodRef('porção de abobrinha (100 g)',
      'porções de abobrinha (100 g)', 20),
  _HealthyFoodRef('porção de chuchu cozido (100 g)',
      'porções de chuchu cozido (100 g)', 20),
  _HealthyFoodRef('porção de berinjela (100 g)',
      'porções de berinjela (100 g)', 25),
  _HealthyFoodRef('porção de brócolis cozido (100 g)',
      'porções de brócolis cozido (100 g)', 25),
  _HealthyFoodRef('porção de couve-flor cozida (100 g)',
      'porções de couve-flor cozida (100 g)', 25),
  _HealthyFoodRef('porção de vagem cozida (100 g)',
      'porções de vagem cozida (100 g)', 30),
  _HealthyFoodRef('porção de pimentão (100 g)',
      'porções de pimentão (100 g)', 25),
  _HealthyFoodRef('porção de cebola (100 g)',
      'porções de cebola (100 g)', 40),
  _HealthyFoodRef('porção de repolho (100 g)',
      'porções de repolho (100 g)', 25),
  _HealthyFoodRef('porção de abóbora cozida (100 g)',
      'porções de abóbora cozida (100 g)', 40),
  _HealthyFoodRef('porção de quiabo cozido (100 g)',
      'porções de quiabo cozido (100 g)', 30),
  _HealthyFoodRef('porção de palmito (100 g)',
      'porções de palmito (100 g)', 30),

  // 🥔 Starchy vegetables / roots
  _HealthyFoodRef('inhame cozido (porção de 100 g)',
      'inhames cozidos (porção de 100 g)', 97),
  _HealthyFoodRef('batata doce cozida (porção de 100 g)',
      'batatas doces cozidas (porção de 100 g)', 77),
  _HealthyFoodRef('batata inglesa cozida',
      'batatas inglesas cozidas', 97),
  _HealthyFoodRef('mandioca cozida (100 g)',
      'porções de mandioca cozida (100 g)', 125),
  _HealthyFoodRef('mandioquinha cozida (100 g)',
      'porções de mandioquinha cozida (100 g)', 80),

  // 🫘 Legumes and pulses
  _HealthyFoodRef('concha de feijão cozido',
      'conchas de feijão cozido', 77),
  _HealthyFoodRef('porção de lentilha cozida (100 g)',
      'porções de lentilha cozida (100 g)', 115),
  _HealthyFoodRef('porção de grão-de-bico cozido (100 g)',
      'porções de grão-de-bico cozido (100 g)', 160),
  _HealthyFoodRef('porção de ervilha cozida (100 g)',
      'porções de ervilha cozida (100 g)', 80),
  ...
  _HealthyFoodRef('castanha-do-pará (2 unidades)',
      'porções de castanha-do-pará (2 unidades)', 65),
